    ...
    private static function render_meta_tab() {
        ...
        <div class="tix-pane active" data-pane="meta">
            ...
            self::meta_card('Datum &amp; Uhrzeit', 'dashicons-calendar-alt', [
                ...
                ['_tix_date_start_formatted', '<span class="tix-badge-bd">Breakdance</span> Formatiertes Startdatum mit Wochentag (z.B. &bdquo;Do., 15.03.2026&ldquo;)', 'Text (D., d.m.Y)'],
                ['_tix_date_end_formatted', '<span class="tix-badge-bd">Breakdance</span> Formatiertes Enddatum mit Wochentag', 'Text (D., d.m.Y)'],
                ['_tix_date_start_long', '<span class="tix-badge-bd">Breakdance</span> Startdatum mit ausgeschriebenem Wochentag (z.B. &bdquo;Donnerstag, 15.03.2026&ldquo;)', 'Text (l, d.m.Y)'],
                ['_tix_date_end_long', '<span class="tix-badge-bd">Breakdance</span> Enddatum mit ausgeschriebenem Wochentag', 'Text (l, d.m.Y)'],
