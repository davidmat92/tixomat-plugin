...
class TIX_Coupon_Popup {
    ...
    public static function render() {
        ...
        ?>
        <style>
            .tix-cp-overlay{position:fixed;inset:0;z-index:99998;background:rgba(15,23,42,.65);backdrop-filter:blur(4px);display:none;align-items:center;justify-content:center;padding:16px;animation:tix-cp-fade .3s ease;}
            .tix-cp-overlay.tix-cp-open{display:flex;}
            .tix-cp-modal{background:#fff;border-radius:20px;max-width:460px;width:100%;padding:0;box-shadow:0 25px 60px rgba(0,0,0,.35);animation:tix-cp-pop .35s cubic-bezier(.4,0,.2,1);overflow:hidden;position:relative;}
            .tix-cp-banner{background:linear-gradient(135deg,#FF5500 0%,#dc2626 100%);color:#fff;padding:30px 28px 28px;text-align:center;position:relative;}
            .tix-cp-banner::before{content:"";position:absolute;inset:0;background-image:radial-gradient(circle at 20% 30%,rgba(255,255,255,.2) 0%,transparent 50%),radial-gradient(circle at 80% 70%,rgba(255,255,255,.15) 0%,transparent 50%);}
            ...
            .tix-cp-headline{font-size:20px;font-weight:700;color:#0f172a;margin:0 0 10px;line-height:1.25;}
            .tix-cp-subtext{font-size:14px;color:#64748b;line-height:1.55;margin:0 0 18px;}
            .tix-cp-code-box{background:#f0fdf4;border:1.5px dashed #22c55e;border-radius:12px;padding:12px 16px;margin:0 0 18px;display:flex;align-items:center;justify-content:space-between;gap:10px;}
            .tix-cp-code-label{font-size:11px;color:#15803d;font-weight:600;text-transform:uppercase;letter-spacing:.06em;}
            .tix-cp-code{font-family:Menlo,monospace;font-size:16px;font-weight:700;color:#15803d;letter-spacing:.05em;}
            .tix-cp-code-status{font-size:11px;color:#16a34a;font-weight:700;display:inline-flex;align-items:center;gap:4px;}
            .tix-cp-cta{background:#0f172a;color:#fff;border:none;padding:14px 24px;border-radius:12px;font-size:15px;font-weight:700;cursor:pointer;width:100%;transition:transform .12s,background .15s;display:inline-flex;align-items:center;justify-content:center;gap:8px;text-decoration:none;}
            .tix-cp-cta:hover{background:#1e293b;transform:translateY(-1px);}
            .tix-cp-close{position:absolute;top:14px;right:14px;background:rgba(255,255,255,.25);color:#fff;border:none;width:32px;height:32px;border-radius:50%;font-size:18px;line-height:1;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:background .15s;z-index:2;backdrop-filter:blur(2px);}
            .tix-cp-close:hover{background:rgba(255,255,255,.4);}
